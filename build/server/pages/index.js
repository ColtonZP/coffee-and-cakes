...
function Home({
  ...
  return __jsx("div", {
    className: "container"
  }, __jsx(next_head__WEBPACK_IMPORTED_MODULE_1___default.a, null, __jsx("title", null, "Coffee Demo"), __jsx("link", {
    rel: "icon",
    href: "/favicon.ico"
    ...
    className: "itemImage",
    src: topAd.coffee.image.url,
    alt: ""
  }), __jsx("p", null, topAd.Description))), __jsx("div", {
    className: "block"
  }, __jsx("img", {
    className: "background",
    ...
    className: "background",
    src: bottomAd.Background.url,
    alt: ""
  }))), __jsx("h1", null, "Fan Favorites"), __jsx("div", {
    className: "favs"
  }, __jsx("div", {
    className: "block"
  }), __jsx("div", {
